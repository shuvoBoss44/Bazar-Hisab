    ...
    <div className="w-full max-w-4xl mx-auto">
      <div className="glass-card p-8 md:p-12 shadow-neon-purple animate-in slide-in-from-bottom relative overflow-hidden">
        ...
        <div className="text-center mb-10 relative z-10">
          <h2 className="text-[length:var(--font-size-3xl)] md:text-[length:var(--font-size-4xl)] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-primary-300 mb-2">
            Upload Transaction
          </h2>
          <p className="text-neutral-400 text-[length:var(--font-size-lg)]">Record a new purchase or update balance</p>
        </div>
