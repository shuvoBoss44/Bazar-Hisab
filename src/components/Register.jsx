...
function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-accent-indigo via-primary-700 to-primary-600 p-4 relative overflow-hidden">
      ...
      <div className="glass rounded-3xl p-8 md:p-12 w-full max-w-md transform transition-all duration-300 hover:shadow-2xl relative z-10 animate-in fade-in slide-in-from-bottom">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/80 text-sm">Join us to manage your transactions</p>
        </div>
